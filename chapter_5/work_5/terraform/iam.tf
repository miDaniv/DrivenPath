resource "aws_iam_role" "mwaa_execution_role_mykhailo" {
  name               = "mwaa_execution_role_mykhailo"
...
resource "aws_iam_policy" "mwaa_policy_mykhailo" {
  name        = "mwaa_execution_policy_mykhailo"
...
resource "aws_iam_role_policy_attachment" "mwaa_role_policy_attachment" {
  role       = aws_iam_role.mwaa_execution_role_mykhailo.name
  policy_arn = aws_iam_policy.mwaa_policy_mykhailo.arn
}


resource "aws_iam_role" "glue_execution_role_mykhailo" {
  name               = "glue_execution_role_mykhailo"
...
resource "aws_iam_policy" "glue_policy_mykhailo" {
  name        = "glue_execution_policy_mykhailo"
...
resource "aws_iam_role_policy_attachment" "glue_role_policy_attachment" {
  role       = aws_iam_role.glue_execution_role_mykhailo.name
  policy_arn = aws_iam_policy.glue_policy_mykhailo.arn
}